...
SELECT 
  ...
  i.itemcallnumber AS genre,
  bi.isbn AS isbn,
  b.copyrightdate AS pub_year,
  i.dateaccessioned AS acquired,
  i.datelastborrowed AS last_borrowed,
  i.issues AS issues,
  i.renewals AS renewals
FROM items i
...
WHERE
  ...
  i.itype='KI'
INTO OUTFILE '/tmp/iteminfo_available.csv'
